...
| Lokale LLM-Sprachaufträge im Codex-Host | Begrenzter Testsatz geprüft | Acht echte Modellturns mit numerischem Grader und 120 CAD-Aufrufen auf dem aktuellen geprüften Build; `reports/llm-eval.json` |
